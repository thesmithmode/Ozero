...
object OzeroIcons {
    ...
    val Power: ImageVector by lazy {
        ImageVector.Builder(
            ...
            moveTo(17.83f, 5.17f)
            lineToRelative(-1.42f, 1.42f)
            cubicTo(19.06f, 7.89f, 20f, 9.82f, 20f, 12f)
            cubicTo(20f, 16.42f, 16.42f, 20f, 12f, 20f)
            cubicTo(7.58f, 20f, 4f, 16.42f, 4f, 12f)
            cubicTo(4f, 9.82f, 4.94f, 7.89f, 6.59f, 6.59f)
            lineTo(5.17f, 5.17f)
            cubicTo(3.19f, 7.19f, 2f, 9.44f, 2f, 12f)
            cubicTo(2f, 17.52f, 6.48f, 22f, 12f, 22f)
            cubicTo(17.52f, 22f, 22f, 17.52f, 22f, 12f)
            cubicTo(22f, 9.44f, 20.81f, 7.19f, 17.83f, 5.17f)
            close()
        }.build()
    }
}
