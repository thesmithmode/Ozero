...
/**
 * Мини JSON-сериализатор без внешних зависимостей. Дублирует engine-xray JsonWriter
 * для изоляции engine-модулей. Поддерживает: Map<String, Any?>, List<Any?>, String, Number, Boolean, null.
 */
