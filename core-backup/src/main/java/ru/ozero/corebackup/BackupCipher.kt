...
internal object BackupCipher {
    ...
    // SENTINEL [backup_one_click_restore]: static key is intentional for one-click cross-device restore; do not replace with passphrase/Keystore without changing the product backup contract.
