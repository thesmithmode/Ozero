...
- Источник серверов — публичные GitHub-репо живых прокси (`kort0881/vpn-vless-configs-russia`,
  `igareck/vpn-configs-for-russia`, `gfpcom/free-proxy-list`, и backup-аггрегаторы).
...
Это политика GitHub, не наша. Можно обернуть в Tor для анонимности при первом
pull (см. RT.5 — Tor on-demand). Никаких наших серверов, никаких access-логов
с нашей стороны (потому что нет наших серверов).
