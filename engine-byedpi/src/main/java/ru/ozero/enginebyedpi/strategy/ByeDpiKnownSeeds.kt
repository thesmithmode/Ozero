...
object ByeDpiKnownSeeds {
    val commands: List<String> = listOf(
        ...
        "-Qr -f-204 -s1:5+sm -a1 -As -d1 -s3+s -s5+s -q7 -a1 -As -o2 -f-43 -a1 -As -r5 -Mh -s1:5+s -s3:7+sm -a1",
        "-Qr -f-205 -a1 -As -s1:3+sm -a1 -As -s5:8+sm -a1 -As -d3 -q7 -o2 -f-43 -f-85 -f-165 -r5 -Mh -a1",
        "-d1+s -s50+s -a1 -As -f20 -r2+s -a1 -At -d2 -s1+s -s5+s -s10+s -s15+s -s25+s -s35+s -s50+s -s60+s -a1",
        "-o1 -a1 -At,r,s -f-1 -a1 -At,r,s -d1:11+sm -S -a1 -At,r,s -Qr -f1 -d1:11+sm -s1:11+sm -S -a1",
        "-d1 -s1 -q1 -Y -a1 -Ar -s5 -o1+s -d3+s -s6+s -d9+s -s12+s -d15+s -s20+s -d25+s -s30+s -d35+s -a1",
        "-f1+nme -t6 -a1 -As -Qr -s1:6+sm -a1 -As -s5:12+sm -a1 -As -d3 -q7 -r6 -Mh -a1",
        ...
        "-f1 -t5 -Qr -q3+h -f2 -q1 -r1+s -t15 -q1 -o2 -a1",
        "-d2:5:2+h -f-3 -r2+sm -o2 -o50+s -r2+s -f-4 -a1",
        ...
        "-o1 -r-5+se -a1 -At,r,s -d1 -Qr -f-1 -a1",
        ...
        "-Qr -f6+nr -d2 -d11 -f9+hm -o3 -t7 -a1",
        ...
        "-f-1 -Qr -s2+s -r3 -o20 -t4 -a7",
        "-Qr -d5+sm -f3+sm -o2 -t4 -a1",
