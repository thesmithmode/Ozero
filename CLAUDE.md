...
- **Никогда не ждать субагентов без дела.** Пока субагент работает — делать следующую задачу из списка, ревью кода, проверять CI, писать тесты, читать контекст. Простой = нарушение.
