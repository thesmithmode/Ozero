...
private fun ModePickStep(
    ...
    Column(
        ...
        ModeCard(
            ...
            icon = { Icon(Icons.Outlined.AutoAwesome, contentDescription = null, modifier = Modifier.size(22.dp)) },
            featureIcon = { Icon(Icons.Outlined.Bolt, contentDescription = null, modifier = Modifier.size(16.dp), tint = Color(0xFF63F5E4)) },
        ...
        ModeCard(
            ...
            featureIcon = { Icon(Icons.Outlined.Settings, contentDescription = null, modifier = Modifier.size(16.dp), tint = MaterialTheme.colorScheme.outline) },
...
private fun ModeCard(
    ...
    val border = if (selected) Color(0xFF63F5E4) else MaterialTheme.colorScheme.outline.copy(alpha = 0.45f)
        ...
        Column(modifier = Modifier.background(bg).padding(16.dp)) {
            Row(modifier = Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
                ...
                Column(modifier = Modifier.weight(1f)) {
                    ...
                    Text(text = hint, style = MaterialTheme.typography.bodyLarge, color = MaterialTheme.colorScheme.onSurfaceVariant)
                }
                icon()
            }
            Spacer(modifier = Modifier.height(12.dp))
            ...
            features.forEach { feature ->
                Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.padding(vertical = 4.dp)) {
                    ...
                    Text(text = feature, style = MaterialTheme.typography.bodyMedium, color = MaterialTheme.colorScheme.onSurfaceVariant)
                }
            }
        }
    }
...
private fun InfoCard() {
    Card(
        ...
        Row(modifier = Modifier.padding(16.dp), verticalAlignment = Alignment.Top) {
            ...
            Spacer(modifier = Modifier.width(12.dp))
            Column {
                Text(text = stringResource(R.string.onboarding_mode_hint_title), style = MaterialTheme.typography.titleMedium)
                Spacer(modifier = Modifier.height(6.dp))
                Text(text = stringResource(R.string.onboarding_mode_hint_body), style = MaterialTheme.typography.bodyMedium, color = MaterialTheme.colorScheme.onSurfaceVariant)
            }
        }
    }
}
