...
## Workflow
- `.memory/` не коммитить и не пушить в промежуточных рабочих коммитах. Коммитить `.memory/` только финальным коммитом после завершения всей пачки задач или по прямой команде пользователя.
